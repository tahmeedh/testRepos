...
const user1 = USERS_INTEG1.WAGT1;
const user2 = USERS_INTEG1.WAGT2;
    ...
    await test.step(`Step 2 - User1 can open existing conversation by creating a conversation`, async () => {
        ...
        await test.step(`THEN`, async () => {
            await test.step(`Header elements are displayed`, async () => {
                ...
                await expect(app1.chatController.Pom.COMPANY_POSITION).toHaveText('Vega Static Company');
                await expect(app1.chatController.Pom.CHAT_HEADER_TEXT).toHaveText('WAGT 2');
        ...
        await test.step(`THEN`, async () => {
            await test.step(`Image preview is displayed for User1`, async () => {
                await test.step(`Header elements are visible`, async () => {
                    ...
                    await expect(app1.attachmentViewerController.Pom.PARTICIPANT_NAME).toHaveText('WAGT 2');
        ...
        await test.step(`THEN`, async () => {
            await test.step(`Image preview is displayed for User2`, async () => {
                await test.step(`Header elements are visible`, async () => {
                    ...
                    await expect(app2.attachmentViewerController.Pom.PARTICIPANT_NAME).toHaveText('WAGT 1');
