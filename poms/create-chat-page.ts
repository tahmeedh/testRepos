...
export class CreateChatPage extends BasePage {
    ...
    constructor (page:Page) {
        ...
        // Channel 
        this.CHANNEL_NAME_BUTTON = this.CHATIFRAME.locator('.m-auto-create-channel-name-region').getByLabel('input-label');
        this.CHANNEL_SUBJECT_REGION = this.CHATIFRAME.locator('.m-auto-create-channel-subject-region').getByLabel('input-label');
        this.CHANNEL_DESCRIPTION_REGION = this.CHATIFRAME.locator('.m-auto-create-channel-description-region').getByLabel('input-label');
        ...
        this.INPUT_RADIO_OPEN_CHANNEL = this.CHATIFRAME.locator('.m-auto-open-membership-radio');
