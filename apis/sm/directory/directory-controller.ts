...
export class DirectoryController {
    ...
    async updateDirectorySettings(companyId: number, directorySettings: DirectorySettingsStruct) {
        try {
            ...
            Log.success(`Profile Policy is updated for company '${companyId}'`);
            return result;
        } catch (error) {
            Log.error(
    ...
    async updateProfile(userId: number, profileInput: any) {
        try {
            ...
            Log.success(`Profile '${keys}' is updated for user '${userId}'`);
            return result;
        } catch (error) {
    ...
    async createDirectoryRoleForUser(userIds: number, operations: string[], roleName: string) {
        try {
            ...
            Log.success(`Role '${roleName}' has been created and assigned to user`);
            return result;
        } catch (error) {
    ...
    async getUserProfile(userId: number) {
        try {
            ...
            Log.success(`User profile of '${userId}' has been obtained`);
            return result;
        } catch (error) {
