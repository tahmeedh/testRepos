export const END_POINTS = {
    ...
    BASE_URL: {
        local: 'https://portal.dev-globalrelay.net',
        cpqa2: 'https://cpqa2portal.dev-globalrelay.net',
        'cpqa2-pd1': 'https://lb3-portal-cpqa2-nvan.dev-globalrelay.net',
        'cpqa2-pd2': 'https://lb4-portal-cpqa2-nvan.dev-globalrelay.net',
        'cpqa2-va1': 'https://lb7-portal-cpqa2-nvan.dev-globalrelay.net',
        'cpqa2-ca1': 'https://lb9-portal-cpqa2-nvan.dev-globalrelay.net',
        'cpqa2-sq1': 'https://lb8-portal-cpqa2-nvan.dev-globalrelay.net',
        cpqa1: 'https://cpqa1portal.dev-globalrelay.net',
        prod: 'https://portal.globalrelay.com',
